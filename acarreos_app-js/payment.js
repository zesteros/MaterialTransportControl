...
var tableSettings = {
 ...
 function sortMe(a, b) {
        return a.childNodes[1]< b.childNodes[1];
  }

j(document).ready(function(){

  //sortUnorderedList(j("#divAplicaciones"), false);
  ...
  var matches = [];
  var searchEles = document.getElementById("divAplicaciones").children;
  for(var i = 0; i < searchEles.length; i++) {
      if(searchEles[i].tagName == 'A') {
  ...
  document.getElementById("divAplicaciones").innerHTML = '';
  for(var i = 0, l = matches.length; i < l; i++) {
    document.getElementById("divAplicaciones").appendChild(matches[i]);
  }
